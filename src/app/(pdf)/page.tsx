  ...
  return (
    <>
      ...
      <PageHeader
        ...
        subtitle="Copilearn turns the Interest Rate Risk lecture into a live workspace: concept cards, a mastery tracker, an interactive rate-shock simulator, and a scored quiz — all generated by the agent. Built to teach a room that has never priced a bond."
      />
      ...
      <main className="flex-1 max-w-[1320px] mx-auto px-6 py-12 w-full">
        <div className="grid md:grid-cols-2 gap-5">
          <ModeCard
            href="/fixed"
            badge="01 · STUDY + GAME WORKSPACE"
            title="Interest Rate Risk, made playable"
            blurb="Opens straight to the Lecture 7 environment: concepts, a mastery tracker, the rate-shock simulator, and a scored quiz."
            bullets={[
              "Drag a yield slider and watch a bond reprice in real time",
              "See where duration's straight-line guess breaks (convexity)",
              "Play the scored quiz; click a concept to go deeper",
            ]}
          ...
          <ModeCard
            ...
            bullets={[
              "“Quiz me on duration” → a scored quiz game",
              "“Flashcards for convexity” → click-to-flip cards",
